...
$app->get('/cart/{slug}/{quantity}', ['Cart\Controllers\CartController', 'add'])->setName('cart.add');
$app->post('/cart/{slug}', ['Cart\Controllers\CartController', 'update'])->setName('cart.update');
